      ...
      <div className="bg-gray-600">
        <div className="flex flex-col items-center justify-center p-4">
          <a href="#" className="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
            ...
            <p className=' h-12  text-3xl  '> Register</p>
          </a>
            ...
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                ...
                {message && <p className="text-sm  text-gray-400 font-semibold dark:text-gray-400">{message}</p>}
                 Already have an account? <NavLink to="/login" className="font-medium text-blue-600 hover:underline dark:text-blue-500">Login here</NavLink>
                </p>
              </form>
